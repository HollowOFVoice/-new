...
if (isset($_GET['edit_id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_worker'])) {
        ...
        header('Location: R28-29.php'); // Перенаправляем пользователя обратно на страницу с формой редактирования
        exit; // Выходим из скрипта, чтобы избежать дальнейшего выполнения кода
    }
}
